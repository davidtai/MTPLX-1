...
def test_dflash2_extra_pins_measured_mlx_version() -> None:
    project = tomllib.loads(Path("pyproject.toml").read_text(encoding="utf-8"))["project"]
    dependencies = project["optional-dependencies"]["dflash2"]

    assert any(dependency.startswith("mlx==0.32.0;") for dependency in dependencies)
