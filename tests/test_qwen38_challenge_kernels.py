...
def test_dflash_m8_nax_island_selects_only_measured_live_o_projection(
    ...
    monkeypatch.setattr(
        ...
        lambda *, active, include_m8_output=True, include_linear_z, include_m7_output=False, include_m7_linear_z=False, include_m8_expanded=False, include_m8_kv=False, include_m8_qkv=False, include_m8_mlp=False, include_m5_exact=False, include_m6_kp1=False: selected.update(active=active)
        or {
            "active": active,
            "width": 8,
...
def test_dflash_m8_nax_island_can_add_measured_linear_attention_z(
    monkeypatch,
) -> None:
    layers = [
    ...
    monkeypatch.setattr(
        "mtplx.nax_verify.configure_qwen38_m8_nax_island",
        lambda *, active, include_m8_output=True, include_linear_z, include_m7_output=False, include_m7_linear_z=False, include_m8_expanded=False, include_m8_kv=False, include_m8_qkv=False, include_m8_mlp=False, include_m5_exact=False, include_m6_kp1=False: selected.update(
            active=active,
            include_linear_z=include_linear_z,
        )
        or {
    ...
    report = configure_qwen38_dflash_m8_nax_island(
        model,
        active=True,
        include_linear_z=True,
    )

    assert selected == {"active": True, "include_linear_z": True}
    assert report["eligible_attention_modules"] == 16
...
def test_dflash_nax_island_can_add_measured_m7_output_route(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "mtplx.nax_verify.configure_qwen38_m8_nax_island",
        lambda *, active, include_m8_output=True, include_linear_z, include_m7_output, include_m7_linear_z=False, include_m8_expanded=False, include_m8_kv=False, include_m8_qkv=False, include_m8_mlp=False, include_m5_exact=False, include_m6_kp1=False: selected.update(
            active=active,
