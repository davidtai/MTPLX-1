...
from mtplx.expert_streaming_models import ExpertStreamingModelSpec, HY3_Q4
...
def _patch_streamed_load_to_live_broker(
    ...
    *,
    ...
    import mtplx.hy3_mtp_patch as hy3_mtp_patch_module
    import mtplx.models.expert_mlx as expert_mlx_module
    import mtplx.models.hy3_mlx as hy3_mlx_module
    ...
    runtime.close = close
    verified_mtp = SimpleNamespace(payload_bytes=1)
    monkeypatch.setattr(
        hy3_mtp_patch_module,
        "open_verified_hy3_mtp_artifacts",
        lambda *_args, **_kwargs: contextlib.nullcontext(verified_mtp),
    )
    monkeypatch.setattr(
        hy3_mtp_patch_module,
