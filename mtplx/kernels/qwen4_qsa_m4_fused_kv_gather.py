...
Emits K and V both as ``[1, H_KV, ROWS, SELECTED, HEAD_DIM]`` -- the layout
the stock rows-gather attention takes, which then builds its score operand
with ``k_sel.swapaxes(-1, -2).reshape(...)``.
"""
