...
def _collect_fixed_m4_captures(
    ...
    so the N-layer prefix and suffix agree with it and with each other.
...
def _forward_fixed_m4_overlap_prefix(
    ...
    *,
    ...
    """Run target embedding and layers ``0..layer_count-1``.
...
def _forward_fixed_m4_overlap_suffix(
    ...
    *,
    ...
    """Run layers ``start..47`` and the target head on a prefix hidden."""
...
def install_qwen4_fixed_verify_route(
    ...
    *,
    ...
    # MTPLX_FABLE_GRAPH_BUILD_OVERLAP_LAYERS: the N-layer pair.  Bound
    ...
    # MTPLX_FABLE_VERIFY_GLUE: contract-check and bit-exactness-probe the
