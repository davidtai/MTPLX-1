...
#: fused glue inside the compiled fixed-M4 verify body.
#:
...
#: ``hc_triple`` (§4, 194 nodes).  ``hc_norm -> hc_down -> hc_up`` cannot
...
#:
#: ``MTPLX_FABLE_QSA_SPARSE_DECODE`` serves the M=4 fixed verify, all 12 QSA
