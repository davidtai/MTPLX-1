...
qwen38_row10_compact_head_calls = 0
    ...
    *,
    ...
    class _CompactDraftHead(nn.Module):
        ...
        def __call__(self, x: Any) -> Any:
            global qwen38_row10_compact_head_calls
            qwen38_row10_compact_head_calls += 1
...
def qwen38_row10_compact_counter_snapshot() -> int:
    return int(qwen38_row10_compact_head_calls)
