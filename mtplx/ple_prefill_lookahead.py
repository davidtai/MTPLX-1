...
row ids and calls ``_SidecarGather.gather_np``.  The prefill attribution
census (cb-sorted i in [432, 7151)) finds eight host-late GPU
...
def _install_receipts():
    """The verdict registry, imported lazily to keep this module a leaf."""
...
def prefill_lookahead_scope(lookahead: "PrefillLookahead | None"):
    ...
    if not lookahead.armed:
        ...
        # Install-verdict counter.  A skipped scope is a BY-DESIGN decline
