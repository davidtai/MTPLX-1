...
- Compute paths require Apple Silicon/macOS and support MLX 0.31-0.32; the repository environment is locked to MLX 0.32.x, while non-compute CLI imports must remain usable without MLX.
