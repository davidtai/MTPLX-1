#!/usr/bin/env python3
"""CPU-only, targeted-field validator + aggregator for the T3 48-envelope-
column real-prefill matrix receipts (2026-07-22): `hy3-oq2e-rq4-48-cachelru`
...
bf16 KV, K1 (+free AR), 3 reps each --
  ...
  ARM 16384:        contexts=16384, output-tokens=256, max-live-kv=16640,
                     ...
                     55 GiB limit ADMITs; cache shrinks to absorb KV growth).
...
Usage:
    PYTHONPATH=<worktree> python3 research/t3-48col/validate_48col.py
"""
...
ARMS = {
    "1024": {
        "prefix": "t3_48col_1024_rep",
        "expected_token_count": 1024,
        "limit_gib": 55.0000,
        "label": "ARM 48x1024 (real prefill)",
    },
    "16384": {
        "prefix": "t3_48col_16384_rep",
        "expected_token_count": 16384,
        "limit_gib": 55.0000,
        "label": "ARM 48x16384 (real prefill)",
    },
    "65536": {
        "prefix": "t3_48col_65536_rep",
        "expected_token_count": 65536,
        "limit_gib": 55.0000,
        "label": "ARM 48x65536 (real prefill)",
    },
    "naturalistic": {
        "prefix": "t3_48col_naturalistic_rep",
        "expected_token_count": 265,
        "limit_gib": 55.0000,
        "label": "ARM naturalistic-48 (~265 tokens)",
    },
}
