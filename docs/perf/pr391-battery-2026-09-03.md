...
The body renders its five charts as images from `docs/perf/pr391-charts/`, which carry their own legends. The mermaid sources for the same series -- and the three fields the body does not chart -- are below, unedited.
