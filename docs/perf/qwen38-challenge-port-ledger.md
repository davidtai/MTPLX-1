...
| Shape-specific exact-BM8 NAX linear-attention `in_proj_z` | + GQA widths 6--8 + BM8 `o_proj` | 728.405 → 732.697 | 67.794 → 65.838 | 37.645 → 37.947 | **-0.7978%** | 35.34683 → 35.34683 | REJECTED; exact tokens, deterministic variants, and all 48 live `5120→6144` projections engaged | `post54-dflash2-m8-linear-z-on-gqa678-m8o-python16384in-1024out-t1-isolated-abba-2026-08-24.json` |
