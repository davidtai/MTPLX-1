...
| Exact-BM8 NAX linear-attention `in_proj_z` | GQA+M8 `o_proj` → + M8 linear-Z | 728.405 → 732.697 | 67.794 → 65.838 | 37.645 → 37.947 | **-0.7978%** | 35.34683 → 35.34683 | Rejected; exact/deterministic, 48 live projections | `post54-dflash2-m8-linear-z-on-gqa678-m8o-python16384in-1024out-t1-isolated-abba-2026-08-24.json` |
