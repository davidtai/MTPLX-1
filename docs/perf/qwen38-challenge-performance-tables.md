...
| 1,024 MiB command buffers, retry | GQA+M8 → + 1,024 MiB | 765.439 → 701.616 | 67.669 → 68.408 | 36.570 → 38.476 | **-4.9557%** | 35.34683 → 47.45434 | Invalid diagnostic; Qwen restarted during window | `invalid-autorestart-post54-dflash2-cb1024-on-gqa678-m8nax-python16384in-1024out-t1-isolated-abba-2026-08-24.json` |
